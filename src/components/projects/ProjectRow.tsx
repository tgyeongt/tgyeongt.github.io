...
export default function ProjectRow({ project }: ProjectRowProps) {
  ...
  return (
    <div id={p.id} className="border-b border-[#cfcfca] scroll-mt-[80px]">
      <div className="grid grid-cols-[36px_1fr_auto] sm:grid-cols-[64px_1fr_auto] gap-3 sm:gap-[22px] py-[26px] px-1 items-center">
      ...
      <div className="pt-2 px-1 pb-10 pl-6 sm:pl-[86px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[repeat(4,minmax(0,410px))] gap-[14px] mb-6 items-start">
          {p.shots.map((sh) => (
